      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid gap-24 md:gap-12 md:grid-cols-3">
          <div className="space-y-4 text-center group">
            ...
            <div className="pt-4">
              <h4 className="text-2xl">Fatih Önemli</h4>
              <span className="block text-sm text-gray-500">Yönetici</span>
            </div>
            <div className="flex justify-center space-x-4 text-gray-500">
              <a href="#" target="_blank" aria-label="facebook">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-6 hover:text-blue-600 bi bi-facebook"
                  fill="currentColor"
                  viewBox="0 0 16 16"
                >
              ...
              <a href="#" target="_blank" aria-label="instagram">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-6 hover:text-blue-600 bi bi-instagram"
                  fill="currentColor"
                  viewBox="0 0 16 16"
                >
              ...
              <a href="#" target="_blank" aria-label="instagram">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-6 hover:text-blue-600 bi bi-twitter"
                  fill="currentColor"
                  viewBox="0 0 16 16"
                >
              ...
              <a href="#" target="_blank" aria-label="instagram">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-6 hover:text-blue-600 bi bi-linkedin"
                  fill="currentColor"
                  viewBox="0 0 16 16"
                >
