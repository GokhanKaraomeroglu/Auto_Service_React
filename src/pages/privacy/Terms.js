...
function Terms() {
  ...
  <div class="px-4 py-24 mb-20 text-left bg-gray-50 md:text-center">
    ...
    <p class="text-base text-gray-500 md:text-lg">Last updated: 10th Sep 2022</p>
  </div>
  <div class="px-4 pb-20 mx-auto prose">
    ...
    <p>In the event you believe that material or content published on the Website may infringe on your copyright or that of another, please <a href="/contact">Contact Us</a>.</p>
  </div>
</section>
