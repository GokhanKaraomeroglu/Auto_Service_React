    ...
    <section className="text-gray-600 body-font">
      <div className="container mx-auto flex px-2 py-12 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <p>
            {" "}
            <strong>Önemli Oto Servisi</strong>'nin miras aldığı en büyük değer
            müşteri memnuniyetidir. Araçlarınızın onarımında yüksek kaliteli
            yedek parçalar ve en hassas ellerden çıkan işcilik kullanılmaktaır.
          </p>
          <p>
            {" "}
            <strong>Önemli Oto Servisi</strong>araçlarınızın bakım ve onarımı
            için kaliteli ve ekonomik çözümler sunar.
          </p>
          <br />
