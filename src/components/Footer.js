        ...
        <div className="md:max-w-md lg:col-span-2">
          ...
          <div className="mt-4 lg:max-w-sm">
            <p className="text-sm text-gray-300">
              Yarım asırlık tecrübesini müşteri memnuniyeti için kullanan güvenilir oto servisi.
            </p>
            <p className="mt-4 text-sm text-gray-300">
              Araçalarınızın bakım, onarım ve kaza sonrası işlemleri titizlikle profesyonel takım arkadaşlarımız tarafından yapılmaktadır.
            </p>
          </div>
        </div>
