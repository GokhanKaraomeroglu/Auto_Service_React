...
const aboutUs = [
  ...
  },
  {
    name: "Hakkımızda",
    description:
      "Tecrübeli yönetim kadromuz ve teknik ekibimizle hizmetinizdeyiz.",
    href: "/about",
...
const resources = [
  {
    ...
    description:
      "Araçlarınızın periyodik bakımlarını uzman kadromuz ile yapmaktayız.",
    href: "/periodic",
    icon: LifebuoyIcon,
  },
  {
    name: "Onarım",
    description:
      "Araçlarınızın onarımında yüksek kaliteli yedek parçalar ve en hassas ellerden çıkan işcilik kullanılmaktadır.",
    href: "/maintenance",
    icon: BookmarkSquareIcon,
  },
  {
